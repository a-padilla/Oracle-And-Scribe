# This file comes from the Arducam team. They put together sample files.
# for using their autofocusing camera. 
# Link to their site is https://www.arducam.com/
# Link to their github is: https://github.com/ArduCAM/RaspberryPi
